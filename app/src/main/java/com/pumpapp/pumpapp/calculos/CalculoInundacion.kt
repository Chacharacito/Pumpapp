...
class CalculoInundacion {
    companion object {
        ...
        fun calcularCaudal(ancho: Double, pendiente: Double, rugosidad: Double, numeroSurcos: Double): Double {
        ...
        fun evaluacion(ancho: Double, pendiente: Double, rugosidad: Double, numeroSurcos: Double, infiltracion: Double,
                       tiempoRiego: Double, longitudSurcos: Double,
                       context: Context
        ) {
